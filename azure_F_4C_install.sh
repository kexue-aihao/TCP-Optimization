...
install_nyanpass(){
  ...
  cmd_run="printf '${service_name}\nn\ny\n' | timeout ${TIMEOUT_NYANPASS} bash \"${installer_file}\" rel_nodeclient \"-t 377d3922-f863-495f-8bfb-9b288412bb00 -u https://wsnbb.wetstmk.lol\""
...
main(){
  ...
  i "[6/6] nyanpass(azjp)"; install_nyanpass
  i "全部任务完成"
}
main "$@"
