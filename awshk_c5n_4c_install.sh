...
net.ipv4.tcp_rmem=4096 380108 50000000
net.ipv4.tcp_wmem=4096 380108 50000000
...
main() {
    ...
    if [[ "$skip_bbr" == false ]]; then
        ...
        log_info "[2/15] BBR加速安装..."
        log_info "已跳过BBR安装"
    fi
    
    # 第三部分：系统参数调优
    log_info "[3/15] 配置系统参数..."
