...
main() {
    ...
    install_nyanpass 1 "awssg1" "b83ad393-1b99-4587-8ef9-66c642ca8641" "https://wsnbb.wetstmk.lol" || true
    
    log_info "[5/5] 安装nyanpass实例2 (gzyd)..."
    install_nyanpass 2 "gzyd" "8c6aa984-f7f9-4e30-a9c7-2fbe45abbfa6" "https://traffic.kinako.one" || true
