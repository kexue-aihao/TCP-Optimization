...
main() {
    ...
    # 第四部分：安装nyanpass实例
    log_info "[4/5] 安装nyanpass实例1 (awskr)..."
    install_nyanpass 1 "awskr" "2738c01b-8980-47af-b952-2b7662d0d0a6" "https://wsnbb.wetstmk.lol" || true
    
    log_info "[5/5] 安装nyanpass实例2 (awskr2)..."
    install_nyanpass 2 "awskr2" "8cb3e364-34eb-43dd-b195-9406289fb991" "https://wsnbb.wetstmk.lol" || true
