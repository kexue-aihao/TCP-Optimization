...
install_nyanpass() {
    ...
    local install_cmd="printf '${service_name}\nn\ny\n' | timeout ${TIMEOUT_NYANPASS} bash <(curl -fLSs https://dl.nyafw.com/download/nyanpass-install.sh) rel_nodeclient \"${install_args}\""
...
main() {
    ...
    # 第四部分：安装nyanpass实例
    log_info "[4/7] 安装nyanpass实例1 (awssg1)..."
    install_nyanpass 1 "awssg1" "-t 29a0924a-8d23-4dcf-882d-dc858e4781e3 -u https://wsnbb.wetstmk.lol" || true
    
    log_info "[5/7] 安装nyanpass实例2 (awssg2)..."
    install_nyanpass 2 "awssg2" "-o -t b83ad393-1b99-4587-8ef9-66c642ca8641 -u https://wsnbb.wetstmk.lol" || true
    
    log_info "[6/7] 安装nyanpass实例3 (jmyd)..."
    install_nyanpass 3 "jmyd" "-o -t e5500cee-24e8-4a4b-a9df-c3d349512ca7 -u https://wsnbb.wetstmk.lol" || true
    
    log_info "[7/7] 安装nyanpass实例4 (gzyd)..."
    install_nyanpass 4 "gzyd" "-o -t 8c6aa984-f7f9-4e30-a9c7-2fbe45abbfa6 -u https://traffic.kinako.one" || true
