...
main() {
    ...
    if [[ "$skip_bbr" == false ]]; then
        ...
        log_info "[2/19] BBR加速安装..."
        log_info "已跳过BBR安装"
    fi
    
    # 第三部分：系统参数调优
    log_info "[3/19] 配置系统参数..."
