...
main() {
    ...
    # 第四部分：安装nyanpass实例
    log_info "[4/5] 安装nyanpass实例1 (awssg)..."
    install_nyanpass 1 "awssg" "cf820b7a-168d-4ad8-b772-bf02bf98b450" "https://wsnbb.wetstmk.lol" || true
    
    log_info "[5/5] 安装nyanpass实例2 (awssg2)..."
    install_nyanpass 2 "awssg2" "b83ad393-1b99-4587-8ef9-66c642ca8641" "https://wsnbb.wetstmk.lol" || true
