...
main() {
    ...
    # 第四部分：安装nyanpass实例（仅保留2个）
    log_info "[4/5] 安装nyanpass实例1 (linode1v6)..."
    install_nyanpass 1 "linode1v6" "99df13c9-beef-4745-9858-ff913791c1ed" "https://wsnbb.wetstmk.lol" || true
    
    log_info "[5/5] 安装nyanpass实例2 (linode2v6)..."
    install_nyanpass 2 "linode2v6" "a6925735-5434-422c-a664-454499219ded" "https://traffic.kinako.one" || true
