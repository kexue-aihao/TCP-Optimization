...
main() {
    ...
    # 第四部分：安装nyanpass实例
    log_info "[4/4] 安装nyanpass实例1 (awskr)..."
    install_nyanpass 1 "awskr" "-o -t 8cb3e364-34eb-43dd-b195-9406289fb991 -u https://wsnbb.wetstmk.lol" || true
