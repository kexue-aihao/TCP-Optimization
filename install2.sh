...
main() {
    ...
    # 第四部分：安装nyanpass实例
    log_info "[4/5] 安装nyanpass实例1 (awssg1)..."
    install_nyanpass 1 "awssg1" "-t 29a0924a-8d23-4dcf-882d-dc858e4781e3 -u https://forwoq.0obbuzld1prxkdt9.lol" || true
    
    log_info "[5/5] 安装nyanpass实例2 (awssg2)..."
    install_nyanpass 2 "awssg2" "-o -t b83ad393-1b99-4587-8ef9-66c642ca8641 -u https://forwoq.0obbuzld1prxkdt9.lol" || true
